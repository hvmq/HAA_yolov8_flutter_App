...
import 'dart:ui';
import 'package:HAA/tflite/classifier.dart';
...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  Future<void> processImage() async {
    if (imagePath != null) {
      ...
      imagesss = img.decodeImage(imageData);

      Map<String, dynamic>? results = classifier!.predict(imagesss!);
      print(results);
    }
  }
...
class DynamicItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
        onTap: () {
          onTapData((data?["PPGSequence"][0] as List<dynamic>).cast<double>());
        },
        onLongPress: () {
          showDialog(
            context: context,
